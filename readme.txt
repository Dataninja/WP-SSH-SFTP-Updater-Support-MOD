...
Contributors: TerraFrost, jenkin
Donate link: http://sourceforge.net/donate/index.php?group_id=198487
Tags: ssh, sftp
Requires at least: 3.1
Tested up to: 4.0
Stable tag: 0.5-jenkin1

"SSH SFTP Updater Support" is the easiest way to keep your Wordpress installation up-to-date with SFTP.

== Description ==

WARNING: this is a customized version (0.5-dataninja1) from 0.5 stable release, fixing incompatibility with WPLMS theme, v1.9.2 on WP 4.2-beta1.
